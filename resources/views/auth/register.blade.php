...
@section('register')
            <section id="signup-section">
                <!-- Section Spacer -->
                <div class="py-40 pt-36 xl:pb-[100px] xl:pt-[180px]">
                    <!-- Section Container -->
                                ...
                                <form action="{{route('register')}}" method="post" class="flex flex-col gap-y-5">
                                    ...
                                    <div class="grid grid-cols-1 gap-6">
                                        ...
                                        <div class="flex flex-col gap-y-[10px]">
                                            <label for="signup-name" class="text-lg font-bold leading-[1.6]">
                                                {{__('Enter your name')}}</label>
                                        ...
                                        <!-- Form Single Input -->
                                        <div class="flex flex-col gap-y-[10px]">
                                            <label for="signup-password" class="text-lg font-bold leading-[1.6]">
                                        ...
                                        <div class="flex flex-col gap-y-[10px]">
                                            <label for="confirm-password" class="text-lg font-bold leading-[1.6]">
