...
<div class="page-wrapper relative z-[1] bg-white">
    ...
    <main   class="main-wrapper relative overflow-hidden">
        ...
        <!--...::: Blog Section Start :::... -->
        <div style="height: 85vh"  id="blog-section">
            <!-- Section Spacer -->
                    ...
                    <div class="table-responsive">
                        <table class="table whitespace-nowrap table-bordered table-bordered-primary border-primary/10 min-w-full">
                            ...
                            <tr class="border-b border-primary/10">
                                <th style="border:1px solid black ;text-align: center">{{__('Order No')}}</th>
                                <th style="border:1px solid black ;text-align: center">{{__('Payment Date')}}</th>
                                <th style="border:1px solid black ;text-align: center">{{__('Order Amount')}}</th>
                                <th style="border:1px solid black ;text-align: center">{{__('Delivery')}}</th>
                                <th style="border:1px solid black ;text-align: center">{{__('Delivery Address')}}</th>
                                <th style="border:1px solid black ;text-align: center">{{__('Coupon Code')}}</th>
                                <th style="border:1px solid black ;text-align: center">{{__('Details')}}</th>
...
{{--                                @php dd($order) @endphp--}}
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        ...
                                        @else
                                            @foreach($OrderProduct as $item)
                                                {{$item->quantity*$item->prices->price*(1-$order->couponDiscount->discount/100)+$order->delivery->prices->last()->price}}
                                            @endforeach
                                    ...
                                    <td style="text-align: center">
                                        <a
                                           href="{{route('orderDetails',['order'=>$order->id])}}">
