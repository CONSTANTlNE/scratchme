                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3 mt-5">
                            ...
                            <article style="height: max-content"
                                ...
                                <a href="{{route('productDetails',$product->slug)}}"
                                    class="block h-[500px] w-full overflow-hidden rounded-[30px]">
                                    @foreach($product->media as $img)
                                        @if($loop->first)
                                    <img src="{{$img->getUrl()}}" alt="blog-main-1" width="416"
                                        height="320"
                                        class=" h-[500px] rounded-[30px] w-full scale-100 object-fit transition-all duration-300 group-hover:scale-105"
                                ...
                                <button data-productid="90" style="margin-bottom: 15px!important;margin-top:0" class="cartbutton button relative z-[1] inline-flex items-center gap-3 rounded-[50px] border-none bg-colorblack py-[18px] text-white hover:text-black mt-5">
                                    {{__('Add to Cart')}}
                                </button>
                                </form>
                                <!-- Blog Content -->
