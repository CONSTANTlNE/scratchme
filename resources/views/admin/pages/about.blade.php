...
<h2 style="color:orange" class="mt-7">Update About</h2>
    ...
    <form action="{{route('updateAbout')}}" method="post">
        @csrf
        <input type="hidden" name="id" @if(isset($about))  value="{{$about->id}} @endif">
        <div class="grid grid-cols-12 gap-6 mt-7">
            <div class="xl:col-span-6 col-span-12">
                <div class=" mb-3 xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <p class="mb-2 text-muted">გვერდის სათაური</p>
                    <input type="text" name="title1_ka" class="form-control" @if(isset($about)) value="{{$about->getTranslation('title1','ka')}}" @endif id="input">
                </div>
                <div class="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <p class="mb-2 text-muted">ტექსტის სათაური<p>
                        <input type="text" name="title2_ka" @if(isset($about)) value="{{$about->getTranslation('title2','ka')}}" @endif class="form-control" id="input">
                </div>
                <div class="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <label for="text-area" class="form-label">ტექსტი</label>
                    <textarea class="form-control" name="content_ka" id="text-area" rows="5">@if(isset($about)) {{$about->getTranslation('content','ka')}} @endif</textarea>
                </div>
            </div>
            <div class="xl:col-span-6 col-span-12">
                <div class=" mb-3 xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <p class="mb-2 text-muted">About Page Heading</p>
                    <input type="text" name="title1_en" @if(isset($about)) value="{{$about->getTranslation('title1','en')}}" @endif class="form-control" id="input">
                </div>
                <div class="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <p class="mb-2 text-muted">Content Title</p>
                    <input type="text" name="title2_en" @if(isset($about)) value="{{$about->getTranslation('title2','en')}}" @endif class="form-control" id="input">
                </div>
                <div class="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <label for="text-area" class="form-label">Content</label>
                    <textarea class="form-control" name="content_en" id="text-area" rows="5">@if(isset($about)) {{$about->getTranslation('content','en')}}@endif</textarea>
                </div>
            </div>
        </div>
